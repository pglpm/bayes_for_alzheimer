...
\hypersetup{colorlinks=true,bookmarksnumbered,pdfborder={0 0 0.25},citebordercolor={0.2667 0.4667 0.6667},citecolor=bluepurple,linkbordercolor={0.6667 0.2 0.4667},linkcolor=redpurple,urlbordercolor={0.1333 0.5333 0.2},urlcolor=green,breaklinks=true}
...
\begin{titlepage}
  ...
  \title{Personalized prognosis \amp\ treatment\\ using an optimal predictor machine:\\ An example study on  conversion\\ from Mild Cognitive Impairment to Alzheimer's Disease}
...
%\markright{\MakeLowercase{\textsc{}}}
  ...
  \author{P.G.L. Porta~Mana\,\href{https://orcid.org/0000-0002-6070-0784}{\protect\includegraphics[scale=0.2]{orcid_32x32.png}}}
\affil{Western Norway University of Applied Sciences, Norway}
  
\author{I.~Rye\,\href{https://orcid.org/0000-0003-4822-9480}{\protect\includegraphics[scale=0.2]{orcid_32x32.png}}}
\affil{University of Oslo, Norway}

\author{A.~Vik\,\href{https://orcid.org/0000-0003-0374-9327}{\protect\includegraphics[scale=0.2]{orcid_32x32.png}}}
\affil{Haukeland University Hospital, Norway}

\author{M.~Koci\'nski\,\href{https://orcid.org/0000-0001-7088-4823}{\protect\includegraphics[scale=0.2]{orcid_32x32.png}},
 A.~Lundervold\,\href{https://orcid.org/0000-0002-6819-6164}{\protect\includegraphics[scale=0.2]{orcid_32x32.png}},  
  A.J.~Lundervold\,\href{https://orcid.org/0000-0001-8663-4247}{\protect\includegraphics[scale=0.2]{orcid_32x32.png}}
}
\affil{University of Bergen, Norway}

\author{A.S.~Lundervold\,\href{https://orcid.org/0000-0001-8663-4247}{\protect\includegraphics[scale=0.2]{orcid_32x32.png}}}
\affil{Western Norway University of Applied Sciences, Norway}
...
\noindent E-Mail: pgl@portamana.org %\break
% \noindent Website: 
}
...
\RepeatTitle{Personalized prognosis \amp\ treatment using an optimal predictor machine:\\ An example study on  conversion\\ from Mild Cognitive Impairment to Alzheimer's Disease}\vskip3pt
...
% ...
-- called \enquote{\ljm} in homage to these two pioneers -- for use in personalized medicine.
...
The \enquote{\ljm} is an algorithmic implementation, as dreamed by Lusted and Ledley\footnote{\cf\ the Appendices in \citealt{lusted1968}.}, of the main calculations underlying the clinical decision-making process: from the comparison of a patient's specific predictors with the statistics offered by a clinical database, to the choice of optimal treatment.\footnote{In previous drafts we called this kind of machine \enquote{Lusted-Jaynes machine} as a homage to Lusted  and to Jaynes \citeyearpar{jaynes1994_r2003}, who brilliantly explained the inductive logic underlying such a \enquote{robot}.}
