...
%% Last-Updated: 2023-11-18T18:51:19+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\firstdraft}{18 November 2023}
...
\newcommand*{\headtitle}{Personalized prognosis \amp\ treatment}
...
%%
\\[1ex]%
\hspace*{\stretch{1}}\parbox{0.3\linewidth}%\makebox[0pt][c]%
...
\hspace*{\stretch{1}}%\\[1ex]%
\parbox{0.3\linewidth}%\makebox[0pt][c]%
{\protect\centering A. J. Lundervold \href{https://orcid.org/0000-0001-8663-4247}{\protect\includegraphics[scale=0.16]{orcid_32x32.png}}%
}\hspace*{\stretch{1}}\mbox{}\\{\footnotesize
...
%  \begin{minipage}{0.75\linewidth}
    \begin{framed}
      ...
      \begin{enumerate}[label=(\arabic*),itemsep=1ex,itemindent=3em]
        \setcounter{enumi}{-1}
