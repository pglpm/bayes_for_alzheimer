...
%% Last-Updated: 2025-02-01T11:11:10+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\section{Introduction: Personalized prognosis, treatment, statistics, and computer algorithms}
\label{sec:intro}
...
We call this algorithm a \emph{\ljm}, for reasons explained in the next section. It is at the moment available as a clinician-friendly proto-package\footnote{\url{https://pglpm.github.io/inferno}; the scripts used in the present work are available at \doi{10.17605/osf.io/zb26t}.} in the R~programming language \autocites{rcoreteam1995_r2023}.
