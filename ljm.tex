...
\newcommand*{\ljm}{Lusted-Jaynes machine}
...
\begin{titlepage}
  ...
  \title{Personalized prognosis \amp\ treatment\\ using Lusted-Jaynes machines:\\ An example study on  conversion\\ from Mild Cognitive Impairment to Alzheimer's Disease}
...
\RepeatTitle{Personalized prognosis \amp\ treatment using Lusted-Jaynes machines:\\ An example study on  conversion\\ from Mild Cognitive Impairment to Alzheimer's Disease}\vskip3pt
...
The \enquote{\ljm} is an algorithmic implementation, as dreamed by Lusted and Ledley\footnote{\cf\ the Appendices in \citealt{lusted1968}.}, of the main calculations underlying the clinical decision-making process: from the comparison of a patient's specific predictors with the statistics offered by a clinical database, to the choice of optimal treatment. The name is a homage to Lusted  and to Jaynes \citeyearpar{jaynes1994_r2003}, who brilliantly explained the inductive logic underlying such a \enquote{robot}.
