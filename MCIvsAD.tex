...
\title[Conversion from Mild Cognitive Impairment to Alzheimer's Disease]{Personalized prognosis \& treatment\\ using Turing-Jaynes machines:\\ An example study on  conversion from Mild Cognitive Impairment to Alzheimer's Disease} 
...
\begin{figure}[!t]% with figure
  ...
  \begin{minipage}{0.49\linewidth}\centering
    ...
    \footnotesize Curtis
  \end{minipage}
  \caption{Probability distributions for full-population frequency of conversion to AD, given Olivia, Ariel, Bianca's and Curtis's predictor values}\label{fig:freq_distribution_patients}
\end{figure}%
