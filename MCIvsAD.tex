...
\documentclass[utf8]{FrontiersinHarvard_mod} % for articles in journals using the Harvard Referencing Style (Author-Date), for Frontiers Reference Styles by Journal: https://zendesk.frontiersin.org/hc/en-us/articles/360017860337-Frontiers-Reference-Styles-by-Journal
...
\def\Authors{P.G.L. Porta~Mana\,$^{1,2,*}$, I.~Rye\,$^{3}$, A.~Vik\,$^{2}$, M.~Koci\'nski\,$^{2,4}$, A.~Lundervold\,$^{2,4}$, A.~J.~Lundervold\,$^{5}$, A.~S.~Lundervold\,$^{1,2}$}
...
\bibitem[{Porta~Mana(2023)}]{portamana2023}
Porta~Mana, P. G.~L. (2023).
\newblock \emph{Ledley-Jaynes machine: an algorithm for Bayesian nonparametric
  density regression}.
\newblock \osfeprint{10.17605/osf.io/zb26t}
\bibAnnoteFile{portamana2023}
...
Woodward, P.~M. (1964).
\newblock \emph{Probability and Information Theory, with Applications to Radar}
  (Oxford: Pergamon), 2 edn.
\newblock \doi{10.1016/C2013-0-05390-X}. First publ.\ 1953
\bibAnnoteFile{woodward1953_r1964}
