...
The frequency-space survey and the calculation of the probabilities for the frequency distributions was done via Gibbs sampling \citetext{\citealp[\chap~4]{neal1993}; \citealp[\sect~29.5]{mackay1995_r2005}; \citealp{casellaetal1992}} using 1024 independent Markov chains. Convergence was assessed by common diagnostic measures \citep{gilksetal1998} and visual inspection. An automated method of convergence check was developed, to be discussed in future publications.
