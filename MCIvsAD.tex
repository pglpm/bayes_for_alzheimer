...
$
    ...
    \end{matrix}$
    &
    $\begin{matrix}6.98\\\bm{7.19}\\7.09\\3.02\\[2\jot]\beta\end{matrix}$
    &
    $\begin{matrix}5.27\\6.16\\\bm{6.58}\\4.73\\[2\jot]\gamma\end{matrix}$
    &
    $\begin{matrix}\bm{6.98}\\6.49\\6.40\\3.02\\[2\jot]\alpha\end{matrix}$
    &
    $\begin{matrix}3.09\\4.85\\5.93\\\bm{6.91}\\[2\jot]\delta\end{matrix}$
    \\[5\jot]
    \hline
  \end{tabular}
