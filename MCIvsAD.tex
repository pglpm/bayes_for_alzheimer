...
\end{wrapfigure}%
We can categorize these differences, schematized in the figure below, as \enquote{difference in auxiliary information} (Olivia and Ariel), \enquote{difference in treatment benefits and losses} (Olivia and Bianca), \enquote{difference in clinical predictors} (Olivia and Curtis).

Considering the similarities and differences among these patients, which of the available treatments is optimal for each of them?
