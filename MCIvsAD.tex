...
These four persons don't know each other, but they have something in common: they all suffer from a mild form of cognitive impairment, and are afraid that their impairment will turn into Alzheimer's Disease within a couple of years. In fact, this is why they recently underwent a clinical examination including a set of cognitive tests. Today they received the results from this examination. Based on these results and other relevant information, their clinician will indicate  risk of developing Alzheimer and make decisions among a set of possible preventive treatment options together with the patients and their relatives.
...
\begin{itemize}
\item Olivia and Ariel turn out to have exactly identical clinical results and age. They would also get similar benefits from the available preventive-treatment options. Ariel, however, comes from a different geographical region than Oliva, and, unlike Olivia, from a family with a heavy history of Alzheimer's Disease. Because of this family background, the clinician judges a priori a 65\% probability that Ariel's cognitive impairment will convert to Alzheimer's Disease
...
\item Olivia and Curtis have different results on most of the neuropsychological tests, in disfavour of Curtis. Furthermore, Olivia does not have the risky Apolipoprotein-E4 (APOE4) allele \citep{liuetal2013} whereas Curtis has, and Olivia is more than 10 years older than Curtis. Otherwise, they come from the same geographical region, have very similar family histories, and would get similar benefits from the preventive options. Note that one clinical result of Curtis's (hippocampal volume) is missing.
\end{itemize}
...
\begin{table}[!h]
  ...
  \begin{tabular}{lcccc}
    ...
    Sex&F&F&F&M \\
    Hippocampus volume ${}/10^{-3}$&4.26&4.26&4.26&[missing] \\
    APOE4 status&N&N&N&Y \\
    Reading test (ANART)&18&18&18&15 \\
    Category Fluency Test&21&21&21&14 \\
    Geriatric Depression Scale&3&3&3&2 \\
    RAVLT-immediate memory &36&36&36&20 \\
    RAVLT-delayed recall &5&5&5&0 \\
    RAVLT-recognition &10&10&10&3 \\
    Trail Making Test A&21&21&21&36 \\
    Trail Making Test B&114&114&114&126
    \\[\jot]
    \hline
