...
\item The \textsf{RAVLT-imm} and \textsf{RAVLT-del} tests are important predictors, both when used alone and when used in combination with all other predictors.
\end{itemize}
