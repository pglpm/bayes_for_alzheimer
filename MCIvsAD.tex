...
The question about Curtis in the previous subsection can be generalized. How important is each predictor in prognosing the conversion to \ad?

The question, as formulated, is too vague (ill-posed) to be answered: what do we mean by \enquote{important}? and in which context
...
How often will the four treatment be prescribed to future patients?
...
\begin{figure}[!t]% with figure
  \centering%
  \includegraphics[width=0.75\linewidth]{plot1000patients.pdf}%
  \caption{Probability and treatments in future patients.}\label{fig:mutual_info}
\end{figure}%
