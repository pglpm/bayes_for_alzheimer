...
\begin{table}[!h]
  ...
  \begin{tabular}{cccccccc}
    ...
    \end{matrix}$
    &
    $\begin{matrix}\nAD&\AD\\[0.5\jot]10&0\\9&3\\8&5\\0&10\end{matrix}$
    &&
    $\begin{matrix}\nAD&\AD\\[0.5\jot]10&0\\9&3\\8&5\\0&10\end{matrix}$
    &&
    $\begin{matrix}\nAD&\AD\\[0.5\jot]10&0\\8&3\\7&5\\0&10\end{matrix}$
    &&
    $\begin{matrix}\nAD&\AD\\[0.5\jot]10&0\\9&3\\8&5\\0&10\end{matrix}$
    \\[5\jot]
    \hline
...
\begin{table}[!h]
  ...
  \begin{tabular}{ccccc}
    ...
    \end{matrix}$
    &
    $\begin{matrix}6.98\\\bm{7.19}\\7.09\\3.02\end{matrix}$
    &
    $\begin{matrix}5.27\\6.16\\\bm{6.58}\\4.73\end{matrix}$
    &
    $\begin{matrix}\bm{6.98}\\6.49\\6.40\\3.02\end{matrix}$
    &
    $\begin{matrix}3.09\\4.85\\5.93\\\bm{6.91}\end{matrix}$
    \\[5\jot]
    \hline
  \end{tabular}
