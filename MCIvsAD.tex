...
We will soon see that despite the many factors in common among these four patients -- even despite the identical clinical results for Olivia, Ariel, Bianca, and despite the identical risk for Olivia and Bianca -- \emph{each patient has an optimal preventive option different from the other three}. The optimal treatments are different owing to the difference in clinical results, auxiliary information, or preventive benefits.
