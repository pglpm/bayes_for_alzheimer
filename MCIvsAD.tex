...
\begin{itemize}
\item The presence of the APOE4 allele is a poor predictor, au pair with sex, both when used alone and when used in combination with all other predictors.
\item The combined cognitive and demographic variates are much better predictors than the combined hippocampal, APOE4, and demographic ones.
