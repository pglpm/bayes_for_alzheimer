...
We close this section emphasizing that the inferential steps of the machine, from input to output, consist, \emph{literally}, in no more than the reiterated application of just three inductive-logic rules:
\begin{equation*}
\begin{gathered}
