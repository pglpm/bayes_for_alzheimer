...
Patients with Mild Cognitive Impairment (MCI) have an increased risk of a trajectory towards Alzheimer's disease (AD). Early identification of patients with a high risk of AD is
...
The present work investigates the prognostic power of a set of neuropsychological and Magnetic Resonance Imaging examinations, demographic data, and genetic information about Apolipoprotein-E (APOE) status, for the prediction of the onset of Alzheimer's disease in patients defined as mildly cognitively impaired at a baseline examination. The longitudinal data used come from the ADNI database.
