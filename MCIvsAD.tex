...
We will soon see that despite the many factors in common among these four patients -- even despite the identical clinical results for Olivia, Ariel, Bianca, and despite the identical probability of conversion for Olivia and Bianca -- \emph{the optimal preventive option for each patient is different from those for the other three}. This difference arises from the difference in clinical results, or auxiliary information, or preventive benefits.
