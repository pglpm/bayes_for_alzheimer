...
The core of our method is the computation of the probabilities of all possible frequency distributions for the full population. This is the maximal amount of information that it is possible to extract from our dataset.
