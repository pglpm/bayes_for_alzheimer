...
which can be compactly represented by a numerical matrix $\bigl(U_{ij})$, where the row index $i$ enumerates the actions, and the column index $j$ enumerates the clinical conditions.
