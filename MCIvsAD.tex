...
\centering%
\makebox[0.49\linewidth]{\centering\footnotesize dataset}%
\hfill%
\makebox[0.49\linewidth]{\centering\footnotesize high-probability candidate population distribution}%
\\[-2em]
...
\\
\makebox[0.49\linewidth]{\centering\footnotesize low-probability candidate population distribution (poor fit)}%
\hfill%
\makebox[0.49\linewidth]{\centering\footnotesize low-probability candidate population distribution (unreasonable)}%
\\[-2em]
