...
From table~\ref{tab:mutual_info}:
\begin{itemize}
\item The presence of the APOE4 allele is a poor predictor, \emph{within the population selected for the dataset}, both when used alone and when used in combination with all other predictors.
