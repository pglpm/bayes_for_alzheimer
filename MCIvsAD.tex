...
\begin{itemize}
\item Olivia and Ariel turn out to have exactly identical clinical results and age. They also have the same preventive-treatment options. Ariel, however, comes from a different geographical region from Olivia, where the conversion rate from Mild Cognitive Impairment to Alzheimer is lower: about 30\%, whereas in Olivia's it is around 45\% \cite{petersenetal1999} Moreover there is no history of Alzheimer in Ariel's family.
\item Olivia and Bianca also have exactly the same clinical results and age. They come from the same geographical region and have very similar family histories. Bianca, however, is soon going to move to another country where a new preventive treatment is available; this option is not open to Olivia.
...
We can categorize these differences as \enquote{difference in auxiliary information} (Olivia and Ariel), \enquote{difference in treatment benefits} (Olivia and Bianca), \enquote{difference in clinical factors} (Olivia and Curtis). Figure\mynotew{***} summarizes the similarity and differences between Olivia and the other three patients. Table\mynotew{***} reports the clinical results and demographic data common to Olivia, Ariel, Bianca, as well as those of Curtis.

We will soon see that despite the many factors in common among these four patients -- even despite the identical clinical results for Olivia, Ariel, Bianca -- \emph{each patient will be prescribed a treatment option different from the other three}.

The difference in treatment originates from the difference in clinical factors\mynotew{}
