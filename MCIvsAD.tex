...
\begin{table}[!h]
  ...
  \begin{tabular}{lcccc}
    ...
    \hline
  \end{tabular}
  \caption{Expected utilities for the four patients}\label{tab:exp_utilities_patients}
\end{table}
...
\begin{table}[!h]
  ...
  \begin{tabular}{lcc}
    \hline\\[-1.5\jot]
    &{\small as sole predictor} &{\small as missing predictor}
    \\[\jot]
    all& 0.140& \\
    none& &0.140 \\
    Age& & 0.139 \\
