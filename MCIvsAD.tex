...
\begin{table}[!t]
  ...
  \begin{tabular}{lcccc}
    ...
    $
    \begin{matrix}
      &\begin{smallmatrix}\smci&\cad\end{smallmatrix}\\
      \begin{smallmatrix}
      \text{treatment $\alpha$}\\
      \text{treatment $\beta$}\\
      \text{treatment $\gamma$}\\
    ...
    0.302&0.302&0.302&0.703
    \\
    {\small $\p(\text{predictors} \| \cad)/10^{-12}$}&
    8.97&8.97&8.97&1.14
    \\
    {\small $\p(\text{predictors} \| \smci)/10^{-12}$}&
    18.6&18.6&18.6&0.343
    \\[\jot]
